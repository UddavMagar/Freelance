                            ...
                            children: <Widget>[
                              Padding(
                                ...
                                child: RaisedButton(
                                  ...
                                  child: Text("Open file picker",style: TextStyle(color: Colors.white),),
                                ),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: RaisedButton(
                                  ...
                                  child: Text("Pick folder",style: TextStyle(color: Colors.white),),
                                ),
                              ),
                            ],
                          ),
                            ...
                            children: <Widget>[
                              Padding(
                                ...
                                child: RaisedButton(
                                  ...
                                  child: Text("Clear temporary files",style: TextStyle(color: Colors.white),),
                                ),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(8.0),
